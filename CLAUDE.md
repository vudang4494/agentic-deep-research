...
# E constant-drift vs config.py · F model literal · G Stage-F single-source (mathfix+mdfix) · H providers ·
...
python3 eval/test_mdfix.py                 # Stage-F markdown hygiene: list/cite/ref numbering, idempotent, fence an toàn
